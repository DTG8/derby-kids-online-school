          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-6 lg:gap-12 mb-6">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="flex gap-2">
                <a
                  href="https://www.facebook.com/people/Derbykidsonlineschool/61581983067751/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="h-8 px-3 bg-blue-400/40 hover:bg-blue-400/60 rounded-lg flex items-center gap-2 text-white transition-colors"
                  aria-label="Facebook"
                >
