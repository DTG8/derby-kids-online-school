...
import { GraduationCap, Mail, Phone, Home, Info, BookOpen, Users, MessageCircle } from "lucide-react";
      ...
      <header className="bg-gradient-to-r from-[#1E40AF] via-[#2563EB] to-[#3B82F6] text-white sticky top-0 z-50 shadow-lg">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Navigation - Icons only, always visible */}
            <div className="flex items-center gap-4 lg:gap-6">
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.name}
                    href={link.href}
                    className={`flex items-center justify-center font-medium transition-all relative group p-3 rounded-xl ${
                      active
              ...
              <Link href="/contact">
                <Button size="lg" className="bg-gradient-to-r from-[#F59E0B] to-[#D97706] hover:from-[#D97706] hover:to-[#F59E0B] text-white font-bold py-2 px-4 xl:px-6 text-sm xl:text-base shadow-xl hover:shadow-2xl whitespace-nowrap">
                  Enroll Now
                </Button>
              </Link>
            </div>
