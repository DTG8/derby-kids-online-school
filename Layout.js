          ...
          <div className="flex flex-col sm:flex-row gap-8 sm:gap-6 lg:gap-12 mb-6">
            ...
            <div className="flex-shrink-0">
              ...
              <div className="flex gap-2">
                <a
                  href="https://www.facebook.com/profile.php?id=61581983067751"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-blue-400/40 hover:bg-blue-400/60 rounded-lg flex items-center justify-center text-white transition-colors"
                  aria-label="Facebook"
                >
